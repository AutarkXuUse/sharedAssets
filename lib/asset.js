...
var generateDistributePlan=function(loanSharedPlanInstance,isFirst){
    ...
    for(var x in loanShareConfirms){
        ...
        if(allTakeInLimit<loanSharedPlanInstance.joinLimit.sharedUpLimit){
            ...
            compeletedLoanSharedPlanReport.token=compeletedLoanSharedPlanReport.limit*loanSharedPlanInstance.joinLimit.tokenRate/10000;
...
var processPartipantValues=function(finishedAssets){
    ...
    finishedAssets.forEach(function(finishedAsset){
        ...
        var contributePromiseObj=new Promise(function(resolve,reject){
            updateParticipantBusinessInfo(finishedAsset.contributeOrg.getIdentifier(),tokenGet,contributeGet,0,finishedAsset.assetID)
                .then(function(){
                    resolve();
                })
                .catch(function(err){
        ...
        // var contributeTokenFlow=new Promise(function(resolve,reject){
        //     addTokenFlow(finishedAsset.contributeOrg,tokenGet,true,"CONTRIBUTION_INCOME")
        //         .then(function(){
        //             resolve();
        //         })
        //         .catch(function(err){
        ...
        //         })
        // })
        // promises.push(contributeTokenFlow);//贡献机构流水账
        ...
        finishedAsset.loanShareConfirms.forEach(function(loanShareConfirm){
            ...
            if(idInReport>-1){ //参与成功的机构
                 ...
                 changeFrozenToken = loanShareConfirm.token*(-1);
            ...
            // var confirmTokenFlow=new Promise(function(resolve,reject){
            //     addTokenFlow(loanShareConfirm.confirmedOrg,changeToken,false,"STORAGE_PAY")
            //         .then(function(){
            //             resolve();
            //         })
            //         .catch(function(err){
            ...
            //         })
            // })
            // promises.push(confirmTokenFlow);//确认机构流水账
 ...
 */
 ...
 function onOrgConfirmAsset(orgConfirmAssetTX){
    ...
    orgConfirmAssetTX.loanShareConfirm.token=orgConfirmAssetTX.loanShareConfirm.confirmTakeInLimit*targetLoanSharedPlan.joinLimit.tokenRate/10000;
